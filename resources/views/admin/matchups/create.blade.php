...
@section('title')
    @if(isset($matchup))Update @else Add @endif MatchUp
@endsection
    ...
    <div class="container-fluid pr-2 pl-2" style="padding: 0 20px!important">
        <div class="card card-default">
            <div class="card-body row">
                ...
                <div class="col-md-12">
                    <form id="create-form" enctype="multipart/form-data" action="{{ isset($matchup)?route('matchup.update'):route('matchup.store') }}" class="form-inline needs-validation"
                          method="POST" novalidate>
                        {{ csrf_field() }}
                        <input type="hidden" value="{{isset($matchup)?$matchup->id:""}}" name="id">
                        @php
                            $inputs = [
                                ["name"=>"name", "label"=>"Name", "value"=>isset($matchup)?$matchup->name:old('name')],
                            ]
                        @endphp
                        ...
                        <div class="col-md-12 input-group justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary mb-2" id="create">
                                <span class="fa fa-save"></span> @if(isset($matchup)) Update @else Create @endif
                            </button>
                        </div>
