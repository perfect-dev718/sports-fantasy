...
{{--                <span class="fa fa-message"></span>--}}
        ...
        <a style="position: absolute; bottom: 10%">
            <div class="menu-items d-flex justify-content-start">
