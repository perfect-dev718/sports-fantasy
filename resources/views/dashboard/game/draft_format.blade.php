        ...
        <div class="row justify-content-center mt-4">
            <div class="col-md-4">
                <div class="p-2" style="border-top: 0.5px solid #5A5889;border-bottom: 0.5px solid #5A5889;">
                    ...
                    <form class="pl-2">
                        <div class="d-flex justify-content-start p-2">
                            <input type="radio" class="form-check-input" name="draft_type" id="double_draft">
                ...
                <div class="mt-3">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <input type="date" class="datepicker p-2" placeholder="Draft Date">
                        </div>
                        <div class="col-6">
                            <input type="time" class="timepicker p-2" placeholder="Select Time">
                        </div>
                    </div>
                </div>
            </div>
